...
then
    ...
    echo './deClaimGroupId.sh [groupId]'
    exit 1
fi
...
echo "Sending deClaimGroupId call..."
# deClaimGroupId(String groupId)
callPayload="$(java -cp $TOOLS_JAR cli.ComposeCallPayload "deClaimGroupId" "$1")"
