...
public class MavenOnIPFS
{
     ...
     */
    @Callable
    public static void publish(String groupId, String artifactId, String version, byte type, String cid) {
        Blockchain.require(groupId != null);
        ...
        MavenOnIPFSEvents.publish(groupId, artifactId, version, type, cid);
    }
